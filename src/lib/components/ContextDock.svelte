...
<script lang="ts">
  ...
  import MnemonicManager from './tools/MnemonicManager.svelte';
  import NomenclatureManager from './tools/NomenclatureManager.svelte';

  type TabId = 'clinical' | 'images' | 'synoptic' | 'tools';
