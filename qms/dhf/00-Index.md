...
| ID | Artifact | Version | Purpose | Path | Status |
|---|---|---|---|---|---|
| 03 | Cybersecurity | 1.1 (2026-04-19) | STRIDE threat model, 10 threats, control matrix, approved vendor set (Azure AI Studio, AWS Bedrock) | qms/dhf/03-Cybersecurity.md | Active |
